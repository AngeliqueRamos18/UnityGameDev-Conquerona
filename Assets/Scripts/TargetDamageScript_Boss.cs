...
public class TargetDamageScript_Boss : MonoBehaviour
{
    public HealthBar hb;
    public PlayerDamaged playerDamaged;
    public Target_MainFunctions_BossCoco target_MainFunctions_BossCoco; 
    ...
    //Debug.Log(target_MainFunctions_S1.isActiveCase);
        if (isCollided)
        {
            if (target_MainFunctions_BossCoco.isActiveCase == true)
            {
