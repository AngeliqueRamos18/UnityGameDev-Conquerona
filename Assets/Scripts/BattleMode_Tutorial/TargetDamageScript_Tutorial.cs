...
public class TargetDamageScript_Tutorial : MonoBehaviour
{
    public HealthBar hb;
    public PlayerDamaged playerDamaged;
    public Target_MainFunctions_Tutorial target_MainFunctions_S1;
    ...
    //Debug.Log(target_MainFunctions_S1.isActiveCase);
        if (isCollided)
        {
            if (Target_MainFunctions_Tutorial.isActiveCase == true)
            {
