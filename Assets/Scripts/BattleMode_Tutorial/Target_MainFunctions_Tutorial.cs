...
public class Target_MainFunctions_Tutorial : MonoBehaviour
{
    ...
    public static bool isActiveCase;
    // Animation States
    ...
    void Update()
    {
        //Test code of angel for getting distance between player and enemy
        ...
        if (isActiveCase == true)
        {
            ...
            switch (currentEnemyState)
            {
                ...
                case basicEnemyStates.Chase:
                    ...
                    //Inserted code for stopping the enemy on pushing the player
                    Debug.Log(distance);
                    if (distance < 0.5211912f)
                    {
                        speed = 0f;
                    }
                    else
                ...
                case basicEnemyStates.Attack:
                    switch (enemyType)
                    {
                        default:
                            ...
                            break;
                        case (1):
                            Debug.Log("ATTACKING _ 1");
                            break;
                        case (2):
                            Debug.Log("ATTACKING _ 2");
                            break;
                    }
                    FindTarget();
